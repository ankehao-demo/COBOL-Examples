...
public class MergeSortProgram {
    ...
    private static void createTestData() throws IOException {
        ...
        writeRecordsToFile(testFile1, TEST_FILE_1);
        writeRecordsToFile(testFile2, TEST_FILE_2);
    }
    ...
    private static void mergeAndDisplayFiles() throws IOException {
        ...
        writeRecordsToFile(allRecords, MERGE_OUTPUT);
    ...
    private static void sortAndDisplayFile() throws IOException {
        ...
        writeRecordsToFile(records, SORTED_OUTPUT);
